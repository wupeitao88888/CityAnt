        ...
        if (isSmail) {
            for (int i = 0; i < startall.getChildCount(); i++) {
                LinearLayout.LayoutParams linearParams1 = (LinearLayout.LayoutParams) startall.getChildAt(i)
                        .getLayoutParams();
                linearParams1.height = (int) DeviceUtils.dp2px(mContext, 11.0f);
                linearParams1.width = (int) DeviceUtils.dp2px(mContext, 10.0f);
            ...
            for (int i = 0; i < startall.getChildCount(); i++) {
                LinearLayout.LayoutParams linearParams = (LinearLayout.LayoutParams) startall.getChildAt(i)
                        .getLayoutParams();
                linearParams.height = (int) DeviceUtils.dp2px(mContext, 19.0f);
                linearParams.width = (int) DeviceUtils.dp2px(mContext, 18.0f);
