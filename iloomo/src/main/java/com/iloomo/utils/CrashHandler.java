...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public static String DISK_APP_CRASH_PATH = "/" +  MApplication.context.getPackageName() + "/crash/";
	...
	public String getSDPath() {
		...
		String path = sdDir.toString() + "/Android/data/" + replace + "/crash/";
...
//			intent.setAction(AppExceptionReceiver.ACTION);
//			intent.putExtra(AppExceptionReceiver.EXCEPTION_FILE_PATH_KEY,errorFilePath );
//			BaseApplication.mContext.sendStickyBroadcast(intent);
//			// 退出程序
//			BaseApplication.activityManager.exitApp(getClass());
			System.exit(1);
		}
	}
